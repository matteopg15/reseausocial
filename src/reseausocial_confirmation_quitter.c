...
int main(void){
	...
	if (succes == 1){
		...
		printf("<body data-theme='b'><div data-role=\"page\" data-theme=\"b\">\n\
			\n\
			<h4>Etes-vous sûr de vouloir quitter ce salon ?<h4><br>\n\
			<form autocomplete='off' action='/cgi-bin/reseausocial_quitter_salon.cgi' method='POST'>\n\
				...
				<button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-icon=\"delete\" class=\"ui-shadow ui-btn ui-btn-b ui-icon-delete ui-btn-icon-top\">Quitter</button>\n\
			</form>\n\
			<form autocomplete='off' action='/cgi-bin/reseausocial_afficher_salon.cgi' method='POST'>\n\
				<input type=\"hidden\" name=\"txt-login\" id=\"txt-login\" value=\"%s\">\n\
				<input type=\"hidden\" name=\"txt-mdp\" id=\"txt-mdp\" value=\"%s\">\n\
				<input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
				<input type=\"hidden\" name=\"txt-salon\" id=\"txt-salon\" value=\"%s\">\n\
				<input type=\"hidden\" name=\"txt-gerant\" id=\"txt-gerant\" value=\"%s\">\n\
				<button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-icon=\"back\" class=\"ui-shadow ui-btn ui-btn-b ui-icon-back ui-btn-icon-top\">Annuler</button>\n\
