...
int main(void){
	...
	char *login, *mdp, *query, *message_erreur, *totpsecret, *activite, *code, *totpcode, *salon, *gerant, *lien ;
	...
	lien           = (char*)malloc(query_size+20000); //Gerant du salon
	...
	if (succes == 1){
		...
		printf("<body data-theme='b'><div data-role=\"page\" data-theme=\"b\"><iframe style=\"position:fixed; top:0; width:100%%; height:100%%;\" src=\"%s\"></iframe>", lien);
		...
		printf("<div data-role=\"footer\" data-position=\"fixed\" data-theme=\"b\" role=\"contentinfo\" class=\"ui-footer ui-bar-b ui-footer-fixed slideup\">\n\
			...
			<ul class=\"ui-grid-c\">\n\
               <li class=\"ui-block-a\">\n\
					...
					<input type=\"hidden\" name=\"txt-entree\" id=\"txt-salon\" value=\"%s\">\n\
					<input type=\"hidden\" name=\"txt-entree\" id=\"txt-gerant\" value=\"%s\">\n\
				  </form>\n\
				</li>\n\
			</ul>\n\
